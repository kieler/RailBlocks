...
export const RailBlocksDeTable = {
  ...
  RAILBLOCKS_CONTACT_WAIT_TEXT: 'Warte bis %2 Kontakt von %3 %1 ist',
  ...
  RAILBLOCKS_CONTACT_WAIT_PASSED: 'überfahren',
  ...
  RAILBLOCKS_CONDITIONAL_TEXT: 'Wenn %1 Kontakt von %2 zuerst erreicht wird\n %3 ansonsten wenn %4 Kontakt von %5 zuerst erreicht wird',
  RAILBLOCKS_CONDITIONAL_TOOLTIP: 'Führe verschiedene Blöcke aus, je nachdem welches Gleis zuerst von einem Zug erreicht wird.',
  ...
  RAILBLOCKS_LIGHTS_TOOLTIP: 'Setze eine Anzahl von Lampen auf entweder an oder aus.\n' + 'Rechtsklicke und wähle Eingang hinzufügen/entfernen aus, um die Anzahl der Lampen zu steuern.',
  ...
  RAILBLOCKS_CONDITIONAL_TEXT_END: 'zuerst erreicht wird',
  RAILBLOCKS_CONDITIONAL_FIRST: 'erster',
  RAILBLOCKS_CONDITIONAL_SECOND: 'zweiter',
  ...
  RAILBLOCKS_TRACK_TOOLTIP: 'Setze eine Anzahl von Gleisen auf eine bestimmte Geschwindigkeit und Richtung.\n' + 'Rechtsklicke und wähle Eingang hinzufügen/entfernen aus, um die Anzahl der Gleisen zu steuern.',

  RAILBLOCKS_POINT_TEXT_START: 'Setze den Punkt',
  RAILBLOCKS_POINT_TEXT_END: 'auf',
  RAILBLOCKS_POINT_TOOLTIP: 'Setze eine Anzahl von Punkten auf entweder verzweigt oder gerade.\n' + 'Rechtsklicke und wähle Eingang hinzufügen/entfernen aus, um die Anzahl der Punkte zu steuern.',
  RAILBLOCKS_POINT_STRAIGHT: 'gerade',
  RAILBLOCKS_POINT_BRANCH: 'verzweigt',
